...
type
  ...
  TPngPredict = object
    public
      function PredictData(const pixels: pbyte; const width, height: integer): pbyte;
  end;
...
function Predict(const pixels: pbyte; const width, height: integer): pbyte;
var
  stride: integer;
  best_score: integer;
...
function TPngPredict.PredictData(const pixels: pbyte; const width, height: integer): pbyte;
begin
  result := Predict(pixels, width, height);
end;
